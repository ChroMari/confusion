...
export const postFeedback = (firstname,lastname,telnum,email,agree,contactType,message)=>(dispatch=>{
    ...
    .then(response => response.json())
    .then(response => alert("Thanks for feedback Submission! "+JSON.stringify(response)))
    .catch(error =>  { console.log('post feedback failed ', error.message); alert('Your comment could not be posted\nError: '+error.message); });
...
export const fetchDishes = () => (dispatch) => {
    ...
    return fetch(baseUrl + 'dishes')
        .then(response => {
            ...
            error => {
                var errmess = new ErrorEvent(error.message);
                throw errmess;
            })
        .then(response => response.json())
